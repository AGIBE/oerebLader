...
def run(config):
    ...
    parameters = {
        ...
        'AMT_OID_BASE': config['LIEFEREINHEIT']['amt_oid_base'],
        'AMT_OID': config['LIEFEREINHEIT']['amt_oid'],
        'EXCEL_AMT': config['GENERAL']['amt_tabelle'],
        'WALDGRENZEN_VERFUEGUNG_DE': config['GENERAL']['waldgrenzen_verfuegung_de'],
        'WALDGRENZEN_VERFUEGUNG_FR': config['GENERAL']['waldgrenzen_verfuegung_fr']
    }
